...
const ForgotPassword: React.FC<ForgotPasswordProps> = ({ setActiveStep }) => {
  const { loading, sendFormDataByForgotPassword, error } =
    useForgotPassword<IForgotPasswordInput>(
  ...
  const onSubmit: SubmitHandler<IForgotPasswordInput> = async (
    formData: IForgotPasswordInput
  ) => {
